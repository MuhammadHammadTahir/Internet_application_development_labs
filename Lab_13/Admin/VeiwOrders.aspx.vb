...
Partial Class Admin_VeiwOrders
    ...
    Private Sub Myinfo_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        cmd.Connection = con
        cmd.CommandText = "SELECT ORDER_T.ORDER_ID, ORDER_T.CUSTOMER_ID, ORDER_T.RECIPIENT, ORDER_T.ORDER_DATE, ORDER_T.ORDER_STATUS, ORDER_T.PAYMENT_METHOD, ORDERLINE.ARTWORK_ID FROM ORDER_T LEFT JOIN ORDERLINE ON ORDER_T.ORDER_ID = ORDERLINE.ORDER_ID"
