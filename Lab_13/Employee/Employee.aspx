<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee.aspx.vb" Inherits="Employee_Employee" %>
        ...
        <div id="form1" runat="server">
            ...
            <div class="navbar">
                <ul class="navbar-list">
                    ...
                    <li class="navbar-list-items"><a class="link" href="Myevents.aspx">My Events</a></li>
                </ul>
            </div>
        </div>
